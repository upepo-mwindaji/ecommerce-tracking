...
describe('Products API:', function() {
  ...
  describe('POST /api/productss', function() {
    ...
    it('should respond with the newly created products', function() {
      expect(newProducts.name).to.equal('New Products');
      expect(newProducts.info).to.equal('This is the brand new products!!!');
    });
  ...
  describe('GET /api/productss/:id', function() {
    ...
    it('should respond with the requested products', function() {
      expect(products.name).to.equal('New Products');
      expect(products.info).to.equal('This is the brand new products!!!');
    });
  ...
  describe('PUT /api/productss/:id', function() {
    ...
    it('should respond with the updated products', function() {
      expect(updatedProducts.name).to.equal('Updated Products');
      expect(updatedProducts.info).to.equal('This is the updated products!!!');
    });
